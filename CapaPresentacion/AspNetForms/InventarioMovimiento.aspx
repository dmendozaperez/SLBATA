<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InventarioMovimiento.aspx.cs" Inherits="CapaPresentacion.AspNetForms.InventarioMovimiento" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="dvReport">
            <CR:CrystalReportViewer ID="crv_Inventario_Movimiento" runat="server" HasCrystalLogo="False"
