<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TabProsp.aspx.cs" Inherits="CapaPresentacion.AspNetForms.TabProsp" %>
...
<body>
   <form id="form1" runat="server">
    ...
    <div id="dvReport">
        <CR:CrystalReportViewer ID="crv_tabla_prosperidad" runat="server" HasCrystalLogo="False"
