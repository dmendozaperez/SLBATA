...
{
    public partial class InventarioMovimiento : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            try
            {
                ...
                crv_Inventario_Movimiento.ReportSource = rd;
                crv_Inventario_Movimiento.ToolPanelView = CrystalDecisions.Web.ToolPanelViewType.None;
                crv_Inventario_Movimiento.HasToggleGroupTreeButton = false;
            }
            catch (Exception exc)
            {
