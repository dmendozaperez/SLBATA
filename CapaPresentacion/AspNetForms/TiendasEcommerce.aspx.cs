...
{
    public partial class TiendasEcommerce : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            try
            {
                ...
                crv_ventas_ecommerce.ReportSource = rd;
                crv_ventas_ecommerce.ToolPanelView = CrystalDecisions.Web.ToolPanelViewType.None;
                crv_ventas_ecommerce.HasToggleGroupTreeButton = false;
