...
{
    public partial class ReportVentaEfectivo : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            try
            {
                ...
                crv_ReportVentaEfectivo.ReportSource = rd;
                crv_ReportVentaEfectivo.ToolPanelView = CrystalDecisions.Web.ToolPanelViewType.None;
                crv_ReportVentaEfectivo.HasToggleGroupTreeButton = false;
            }
            catch (Exception exc)
            {
