...
{
    public partial class ReportCuponRedimidos : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            try
            {
                ...
                crv_ReportCuponRedimidos.ReportSource = rd;
                crv_ReportCuponRedimidos.ToolPanelView = CrystalDecisions.Web.ToolPanelViewType.None;
                crv_ReportCuponRedimidos.HasToggleGroupTreeButton = false;
            }
            catch (Exception exc)
            {
